...
sleep 1
rm -rf $out/db-hang
./build/kdbsvr.exe init "disk://$ROOT/build/perf/db-hang" >/dev/null 2>&1
./build/kdbsvr.exe server 1 9421 9422 "disk://$ROOT/build/perf/db-hang" "1@127.0.0.1:9421:9422" > $out/hang-srv.log 2>&1 &
sleep 6
