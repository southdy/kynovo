...
./build/kdbsvr.exe init "disk://D:/kynovo/build/cl13/a" >/dev/null
(./build/kdbsvr.exe server 1 8401 8402 "disk://D:/kynovo/build/cl13/a" "1@127.0.0.1:8401:8402" > build/cl13/a.log 2>&1 &)
sleep 6
...
for i in 1 2 3; do ./build/kdbsvr.exe init "disk://D:/kynovo/build/cl13/n$i" >/dev/null; done
SPEC="1@127.0.0.1:8411:8421,2@127.0.0.1:8412:8422,3@127.0.0.1:8413:8423"
start_node(){ ./build/kdbsvr.exe server $1 $2 $3 "disk://D:/kynovo/build/cl13/n$1" "$SPEC" > build/cl13/s$1.log 2>&1 & }
