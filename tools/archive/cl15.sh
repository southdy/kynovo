...
./build/kdbsvr.exe init "disk://D:/kynovo/build/cl15/a" >/dev/null
(./build/kdbsvr.exe server 1 8601 8602 "disk://D:/kynovo/build/cl15/a" "1@127.0.0.1:8601:8602" > build/cl15/a.log 2>&1 &)
sleep 6
