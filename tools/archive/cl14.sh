...
./build/kdbsvr.exe init "disk://D:/kynovo/build/cl14/a" >/dev/null
(./build/kdbsvr.exe server 1 8501 8502 "disk://D:/kynovo/build/cl14/a" "1@127.0.0.1:8501:8502" > build/cl14/a.log 2>&1 &)
sleep 6
