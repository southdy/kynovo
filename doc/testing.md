...
| L1b | server unit (with stress mode) | `./build/kserver_test.exe` | `SUMMARY: 40/40 passed` | ~30s |
...
- unit suites at that guest run: `cemon_test 5/5`, `kclient_test 18/18` (the rx-buffer case made it 19), `raft_test 221/221`, `kserver_test 37/37` (the ceiling, middle-cut and install cases landed afterwards: 40/40 in the tree),
